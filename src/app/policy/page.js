export default function Policies() {
  return (
    <div className="bg-amber-50 max-w-7xl mx-auto p-4">
      <h1 className="text-3xl font-semibold text-center mb-8">Políticas da Loja MOTF</h1>

      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Política de Trocas e Devoluções</h2>
        <p className="text-lg text-gray-600 mb-4">
          De acordo com o Código de Defesa do Consumidor (Lei nº 8.078/90), o cliente da loja MOTF tem o direito de desistir da compra no prazo de até 7 (sete) dias 
      ...
      <section className="mb-12">
        ...
        <p className="text-lg text-gray-600 mb-4">
          O prazo de envio na loja MOTF começa a contar após a confirmação do pagamento. O prazo de entrega varia conforme a localidade e o tipo de frete escolhido:
        </p>
        <ul className="list-disc pl-6 text-lg text-gray-600 mb-4">
      ...
      <section className="mb-12">
        ...
        <p className="text-lg text-gray-600 mb-4">
          Na loja MOTF, aceitamos os seguintes métodos de pagamento:
        </p>
        <ul className="list-disc pl-6 text-lg text-gray-600 mb-4">
      ...
      <section>
        ...
        <p className="text-lg text-gray-600 mb-4">
          A loja MOTF garante o sigilo dos dados informados no momento da compra. As informações pessoais como nome, endereço e e-mail são utilizadas exclusivamente para processar e entregar o pedido.
        </p>
        <p className="text-lg text-gray-600 mb-4">
